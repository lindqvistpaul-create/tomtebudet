...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-hero overflow-hidden">
      {/* Decorative elements */}
      <div className="absolute top-20 left-10 text-accent/30 animate-float">
      ...
      <div className="container mx-auto px-4 py-20 relative z-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-snow/90 text-sm font-medium">Magisk julhälsning från tomtens verkstad</span>
          </div>
          ...
          >
            Skicka en personlig julhälsning från tomtens verkstad. 
            Låt magin sprida glädje till dina nära och kära.
          </p>
          ...
          >
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-serif text-accent mb-1">12k+</div>
              <div className="text-snow/60 text-sm">Hälsningar skickade</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-serif text-accent mb-1">100%</div>
              <div className="text-snow/60 text-sm">Magisk garanti</div>
            </div>
            <div className="text-center">
              <div className="text-3xl md:text-4xl font-serif text-accent mb-1">∞</div>
              <div className="text-snow/60 text-sm">Julkärlek</div>
            </div>
          </div>
        </div>
      </div>
